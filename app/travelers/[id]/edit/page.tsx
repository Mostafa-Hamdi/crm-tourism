...
const studentSchema = yup.object().shape({
  ...
  relativeName: yup
    ...
    .min(2, "Travel companion name must be at least 2 characters")
    .max(100, "Travel companion name must not exceed 100 characters"),
  ...
  level: yup
    ...
    .max(50, "Trip type must not exceed 50 characters"),
});
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                    Travel Companion <span className="text-red-500">*</span>
                  </label>
                  <div className="relative">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2">
                      <User className="w-5 h-5 text-gray-400" />
                    ...
                    <input
                      ...
                      placeholder="Travel Companion name"
                      className={`w-full bg-gradient-to-r from-gray-50 to-blue-50/50 border-2 ${
                        errors.relativeName
                          ? "border-red-300"
                          : "border-gray-200"
              ...
              >
                ...
                {isUpdating ? (
                  <>
                    ...
                    <span className="relative z-10">Updating Traveler...</span>
                  </>
                ) : (
                  <>
                    <Save className="w-5 h-5 relative z-10" />
                    <span className="relative z-10">Update Traveler</span>
                  </>
                )}
              </button>
            </div>
